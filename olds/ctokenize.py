...
patterns = [(r'^switch', ctoken.CTokenType.KEY_SWITCH),
    ...
    (r'^%=', ctoken.CTokenType.OP_REM_ASN),
    (r'^\&=', ctoken.CTokenType.OP_BITS_AND_ASN),
    (r'^\|=', ctoken.CTokenType.OP_BITS_OR_ASN),
    (r'^\^=', ctoken.CTokenType.OP_BITS_XOR_ASN),
    (r'^->', ctoken.CTokenType.OP_R_ARROW),
    (r'^\*', ctoken.CTokenType.OP_MUL),
    (r'^\/', ctoken.CTokenType.OP_DIV),
    (r'^\%', ctoken.CTokenType.OP_REM),
    ...
    (r'^\|', ctoken.CTokenType.OP_BITS_OR),
    (r'^\&\&', ctoken.CTokenType.OP_LOGIC_AND),
    (r'^<<', ctoken.CTokenType.OP_L_SHIFT),
    (r'^>>', ctoken.CTokenType.OP_R_SHIFT),
    (r'^<<=', ctoken.CTokenType.OP_L_SHIFT_ASN),
    (r'^>>=', ctoken.CTokenType.OP_R_SHIFT_ASN),
    (r'^\|\|', ctoken.CTokenType.OP_LOGIC_OR),
    (r'^\^', ctoken.CTokenType.OP_BITS_XOR),
    ...
    (r'^\?', ctoken.CTokenType.PC_QUESTION),
