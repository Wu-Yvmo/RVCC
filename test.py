...
test_items = [
    ...
    (r'{5==2+3;}', 1),
    (r'{6==4+3;}', 0),
    (r'{0*9+5*2==4+4*(6/3)-2;}', 1),
    (r'{1; 2; 3;}', 3),
    (r'{12+23;12+99/3;78-66;}', 12),
    (r'{int a=3; a;}', 3),
    (r'{int a=3; a;}', 3),
    (r'{int a=3; int z=5; a+z;}', 8),
    (r'{int a, b; a=b=3; a+b;}', 6),
    (r'{int a=3;int b=4;a=1;a+b;}', 5),
    (r'{int foo=3; foo;}', 3),
    (r'{int foo2=70; int bar4=4; foo2+bar4;}', 74),
]
